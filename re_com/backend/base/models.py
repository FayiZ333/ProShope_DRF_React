...
class Product(models.Model):
    ...
    brand = models.CharField(max_length=333, null=True,blank=True)
    category = models.CharField(max_length=333, null=True,blank=True)
...
class Order(models.Model):
    user = models.ForeignKey(User, on_delete=models.SET_NULL, null=True)
    paymentmethod = models.CharField(max_length=333, null=True,blank=True)
...
class OrderItem(models.Model):
    ...
    price = models.IntegerField(null=True, blank=True)
    image = models.CharField(max_length=333, null=True,blank=True)
    _id = models.AutoField(primary_key=True, editable=False)
...
class ShippingAddress(models.Model):
    ...
    city = models.CharField(max_length=333, null=True,blank=True)
    postalCode = models.CharField(max_length=333, null=True,blank=True)
    country = models.CharField(max_length=333, null=True,blank=True)
    shippingPrice = models.IntegerField(null=True, blank=True)
    _id = models.AutoField(primary_key=True, editable=False)
